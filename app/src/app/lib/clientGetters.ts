...
import { InfoCardsAPI } from "../api/utils/info-cards/route";
...
export async function getInfoCards(): Promise<InfoCardsAPI> {
    return fetch('/api/utils/info-cards').then((res) => res.json())
}
